...
x_1tijd = flight_1_30['Time (secs)'] / 60
x_2tijd = flight_2_30['Time (secs)'] / 60
x_3tijd = flight_3_30['Time (secs)'] / 60
x_4tijd = flight_4_30['Time (secs)'] / 60
x_5tijd = flight_5_30['Time (secs)'] / 60
x_6tijd = flight_6_30['Time (secs)'] / 60
x_7tijd = flight_7_30['Time (secs)'] / 60
...
plt.legend()
ax1.set_xlabel('Tijd in minuten')  # Updated label
ax1.set_ylabel('Altitude in feet')
